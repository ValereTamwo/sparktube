...
function Navbar({setSearch,search,setToggle, togglebar, auth, setAuth ,mobile,setUser,user}) {
  ...
  return (
      <header className='container-fluid border-b  fixed-top bg-white' id='head'>
          <div className='row navbar navbar-expand-md'>
             <section className='logo navbar-brand col-md-3 col-5  bg-white p-1 '>
              ...
              {mobile?<></>:<section className='col-md-5 col-3 p-1 search '>
                  <form action="" id="searchForm" class="d-flex ms-auto ">
                      <div class="input-group">
                          ...
                          <Link type="submit " to='/search' className="btn w-[4rem] flex justify-center items-center btn-warning rounded-r-[30px] ">
            ...
            <section className='col-md-4      col-6 p-0 flex justify-end pe-md-5  user'>
                  <div className={auth?'flex container md:justify-end md:gap-7 justify-between':'flex container  md:justify-end md:gap-7 justify-between'}>
